...
The mark is a torii: its two posts are the twin **I**, and a torii is a threshold —
which is what the tool measures, work crossing out of the field it came from. Cuts
and geometry are in [`brand/`](brand/).
